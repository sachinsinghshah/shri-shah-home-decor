...
export default function WhatsAppButton() {
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {/* Tooltip */}
      <div
        className="pointer-events-none absolute bottom-16 right-0 rounded-lg px-3 py-1.5 text-xs font-medium whitespace-nowrap opacity-0 shadow-md transition-opacity duration-200 group-hover:opacity-100"
        style={{
